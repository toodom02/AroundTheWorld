...
export class CharacterController {
    ...
    Update(timeInSeconds) {
        ...
        const position = new THREE.Vector3(this._playerBody.position.x, this._playerBody.position.y, this._playerBody.position.z);
        // Local "up" is from globe center
        const localUp = position.clone().normalize();
        // Get current orientation
        const quaternion = new THREE.Quaternion(this._playerBody.quaternion.x, this._playerBody.quaternion.y, this._playerBody.quaternion.z, this._playerBody.quaternion.w);
        ...
        const correctedForward = new THREE.Vector3()
            ...
            .normalize();
        const mat = new THREE.Matrix4().makeBasis(localRight, localUp, correctedForward);
        ...
        const playerPosition = new THREE.Vector3(this._playerBody.position.x, this._playerBody.position.y, this._playerBody.position.z).add(offset);
