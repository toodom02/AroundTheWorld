...
export class Planet {
    ...
    _Init() {
        const planetGeometry = new THREE.SphereGeometry(this._params.planetRadius, 64, 64);
        ...
        this._planetBody.position = new CANNON.Vec3(this._planet.position.x, this._planet.position.y, this._planet.position.z);
