...
export class Ball {
    ...
    _Init() {
        ...
        this._ballBody.position = new CANNON.Vec3(this._ball.position.x, this._ball.position.y, this._ball.position.z);
        const contactMaterial = new CANNON.ContactMaterial(ballPhysMaterial, this._params.groundMaterial, {
            friction: 0.4,
            restitution: 0.2,
        });
